...
(function (FudgeStory) {
    ...
    class Base {
        ...
        static setup() {
            ...
            ƒ.Loop.start();
            ƒ.Loop.addEventListener("loopFrame" /* ƒ.EVENT.LOOP_FRAME */, FudgeStory.Animation.update);
        }
        /**
...
(function (FudgeStory) {
    ...
    class Animation extends FudgeStory.Base {
        ...
        static async attach(_pose, _animation, _playmode) {
            ...
            cmpAnimator.addEventListener("componentActivate" /* ƒ.EVENT.COMPONENT_ACTIVATE */, Animation.trackComponents);
            cmpAnimator.addEventListener("componentDeactivate" /* ƒ.EVENT.COMPONENT_DEACTIVATE */, Animation.trackComponents);
        ...
        static trackComponents = (_event) => {
            ...
            if (_event.type == "componentDeactivate" /* ƒ.EVENT.COMPONENT_DEACTIVATE */ && index > -1) {
        ...
        static fade(_url, _toVolume, _duration, _loop = false) {
            ...
            return new Promise((resolve) => {
                let hndLoop = function (_event) {
                    ...
                    ƒ.Loop.removeEventListener("loopFrame" /* ƒ.EVENT.LOOP_FRAME */, hndLoop);
